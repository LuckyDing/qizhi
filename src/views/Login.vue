  ...
  <div class="body" ref="content" v-title="'登录'">
    <div class="login_area">
      <div class="logo">
        ...
        <div class="logo_item">
          <div class="title">七智厨房海外版管理系统</div>
...
export default {
  ...
  methods: {
    login () {
      ...
      this.$get('getAuthor', null, function (data) {
        sessionStorage.setItem('token', data.author.token)
        // _this.$cookies.set('token', data.author.token, '60s')
        _this.$router.push({ path: 'Menus/Users/UIndex' })
      })
    },
    shake () {
      this.shaking = 1
