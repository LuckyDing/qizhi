    ...
    <el-container>
      <el-header class="header">
        <div style="display:inline-block">
          <router-link :to="{ path: '/Menus/Message/MIndex' }"><span class="link">推送管理</span></router-link>
      ...
      <el-main style="padding:0 20px">
        <div class="form">
          ...
          <div class="form_item">
            <span class="form_cell">描述：</span>
            <el-input class="form_cell" v-model="form.username" :maxlength="30" :placeholder="'不超过50个字'"></el-input>
          </div>

          <div class="form_item">
            <span class="form_cell">内容：</span>
            <UEditor class="form_cell" :config='config' ref="ue"></UEditor>
          </div>
