  ...
  <div class="content">
    <el-container>
      <el-header style="height:51px">
        <div class="tabs">
          <span class="tab_item tab_item_on">操作指南</span>
      ...
      <el-main style="padding:0 20px">
        <div class="search_box">
          <div class="search_content">
            <div class="search_item">
              ...
              <router-link :to="{ path: 'ArticleEdit/' + 'edit/' + '-1' }">
                <el-button size="small" icon="el-icon-plus" class="float-right" style="margin-top:1em;">&ensp;创建文章</el-button>
              </router-link>
            </div>
          </div>
        </div>
        <div class="table">
          <el-table :data="dataList" style="width: 100%" :border="true">
            ...
            <el-table-column prop="title" label="标题" width="365"></el-table-column>
            <el-table-column prop="add_time" label="创建时间" width="365"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    edit (id) {
      this.$router.push({ path: 'ArticleEdit/' + 'edit' + '/' + id })
    }
  }
}
</script>
